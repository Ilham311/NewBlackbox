...
public class IWebViewUpdateServiceProxy extends BinderInvocationStub {
    ...
    protected Object getWho() {
        try {
            ...
            Method getUpdateServiceMethod = webViewFactoryClass.getDeclaredMethod("getUpdateService");
            getUpdateServiceMethod.setAccessible(true);
            return getUpdateServiceMethod.invoke(null);
        } catch (Exception e) {
            Slog.w(TAG, "Failed to get WebViewUpdateService", e);
            return null;
        }
    }
